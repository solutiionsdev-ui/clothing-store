...
> [!tip] Adding to the home page?
> Route `/` already exists: `src/views/home/index.tsx` renders the hero. A new
> home-page section goes in `src/views/home/<section>/` and is composed into the
