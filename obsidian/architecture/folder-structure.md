...
│   └── home/               # A page with sections becomes a folder:
│       ├── index.tsx       #   the view (Server Component)
│       └── hero/           #   its sections live beside it, not in components/
...
| A page's UI | `views/<page-name>.tsx`, or `views/<page-name>/index.tsx` once it has sections — see [[new-page]] |
| A section of a page | `views/<page-name>/<section>/` — beside the view, **not** in `components/` |
